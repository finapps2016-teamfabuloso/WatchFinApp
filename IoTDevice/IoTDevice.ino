...
char ssid[] = "FinAppsParty2"; //  your network SSID (name)
char pass[] = "Global2016"; // your network password (use for WPA, or use as key for WEP)
int keyIndex = 0;            // your network key Index number (needed only for WEP)

int status = WL_IDLE_STATUS;

char deviceId[] = "4910409ebdbaaafdada2b7a6bf7542e5"; // Feed you want to post to
char m2xKey[] = "a22deb974804f7180fb555de87d18556"; // Your M2X access key
char streamName[] = "texaco"; // Stream you want to post to
